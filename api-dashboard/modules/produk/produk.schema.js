...
module.exports = {
  get: {
    ...
    querystring: {
      ...
      statusNewRealease: {
        type: "string",
        description: "Query untuk filter berdasarkan status new realease produk"
      }
    },
    response: {
      200: {
  ...
  post: {
    ...
    body: {
      type: "object",
      required: ["kode","name","price","stock","size", "categori", "description", "tags", "photos"],
      properties: {
        kode: { type: "string", description: "kode produk" },
        name: { type: "string", description: "nama produk "},
        price: { type: "number", description: "harga produk"},
  ...
  put: {
    ...
    body: {
        type: "object",
        required: ["kode","name","price", "stock","size","categori", "description", "tags", "photos","status","statusNewRealease"],
        properties: {
          kode: { type: "string", description: "kode produk" },
          name: { type: "string", description: "nama produk "},
          price: { type: "number", description: "harga produk"},
          ...
          description: {type: "string", description: "deskripsi produk"},
          tags: {type: "string", description: "tag produk"},
          status: {type: "boolean", description: "status realease produk"},
          statusNewRealease: {type: "boolean", description: "status new realease produk"},
          photos: {type: "object", properties: {p1: {type: "string", description:"photo produk 1"}, p2: {type: "string", description:"photo produk 2"}, p3: {type: "string", description: "photo produk 3"}}}
        },
    },
    response: {
